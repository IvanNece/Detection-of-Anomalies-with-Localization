...
We employ a ResNet-50 backbone pre-trained on ImageNet with frozen weights. Features are extracted from two intermediate layers, \texttt{layer2} (256 channels, $28 \times 28$ spatial resolution for $224 \times 224$ input) and \texttt{layer3} (1024 channels, $14 \times 14$ resolution), to capture both fine-grained and semantic information.
