...
Table~\ref{tab:split_statistics} summarizes the dataset composition for each category and split, and Figure~\ref{fig:split_distribution} provides a visual representation of the distribution.
